  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center hero-gradient overflow-hidden">
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute bottom-1/4 -right-32 w-96 h-96 bg-violet-500/10 rounded-full blur-3xl animate-pulse-glow" style={{ animationDelay: '2s' }} />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center pt-24 pb-16">
        ...
        <h1 className="font-display font-extrabold text-4xl sm:text-5xl md:text-6xl lg:text-7xl text-white leading-tight mb-6 max-w-5xl mx-auto">
          ...
          <br />
          <span className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl text-slate-300">Aplicada a la Gestión Administrativa</span>
        </h1>

        <p className="text-lg sm:text-xl text-slate-400 max-w-3xl mx-auto mb-10 leading-relaxed">
          Domina las herramientas de IA que están transformando las oficinas modernas. Desde prompts básicos hasta automatización completa de procesos, sin escribir una sola línea de código.
        </p>

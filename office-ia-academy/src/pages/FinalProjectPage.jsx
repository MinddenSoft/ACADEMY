  ...
  return (
    <div className="min-h-screen bg-neutral-50 dark:bg-dark-900">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pt-28 pb-16">
        ...
        <div className="relative rounded-2xl bg-white dark:bg-dark-800 border border-neutral-100 dark:border-white/10 overflow-hidden shadow-xl dark:shadow-none">
          ...
          <div className="p-8 sm:p-10 lg:p-14">
            ...
            <h1 className="font-display font-bold text-3xl sm:text-4xl text-primary-900 dark:text-white mb-4">
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-12">
              <div className="p-6 rounded-xl bg-primary-50/50 dark:bg-primary-900/20 border border-primary-200 dark:border-primary-800">
                <div className="flex items-center gap-3 mb-4">
                  <div className="w-10 h-10 rounded-lg bg-primary-50 dark:bg-primary-900/30 border border-primary-200 dark:border-primary-800 flex items-center justify-center">
                    <span className="text-primary-500 dark:text-primary-400 font-bold text-sm">01</span>
                  </div>
                  <h3 className="font-display font-bold text-lg text-primary-900 dark:text-white">El Reto</h3>
                </div>
              ...
              <div className="p-6 rounded-xl bg-primary-50/50 dark:bg-primary-900/20 border border-primary-200 dark:border-primary-800">
                <div className="flex items-center gap-3 mb-4">
                  <div className="w-10 h-10 rounded-lg bg-primary-50 dark:bg-primary-900/30 border border-primary-200 dark:border-primary-800 flex items-center justify-center">
                    <span className="text-primary-500 dark:text-primary-400 font-bold text-sm">02</span>
                  </div>
            ...
            <div className="rounded-xl bg-neutral-50 dark:bg-dark-900/50 border border-neutral-100 dark:border-white/5 p-8 mb-10">
              <h3 className="font-display font-bold text-lg text-primary-900 dark:text-white mb-6">Habilidades que demostrarás</h3>
              <div className="grid sm:grid-cols-2 gap-4">
                {[
                  ...
                  <div key={i} className="flex items-start gap-3 p-4 rounded-lg bg-white dark:bg-dark-800 border border-neutral-100 dark:border-white/5">
                    ...
                    <span className="text-sm text-neutral-700 dark:text-neutral-300">{item.skill}</span>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="p-6 rounded-xl bg-primary-50/50 dark:bg-primary-900/20 border border-primary-200 dark:border-primary-800">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h4 className="font-display font-bold text-lg text-primary-900 dark:text-white">Certificación Experto No-Code</h4>
                  <p className="text-neutral-600 dark:text-neutral-400 text-sm">Al completar exitosamente el proyecto final, recibirás tu certificación como Profesional Experto en IA aplicada a la gestión administrativa.</p>
                </div>
              </div>
            </div>

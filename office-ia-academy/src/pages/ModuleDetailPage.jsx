            ...
            <div key={si} className="rounded-2xl bg-white dark:bg-dark-800 border border-slate-200 dark:border-white/5 overflow-hidden shadow-sm dark:shadow-none hover:shadow-md dark:hover:shadow-white/5 transition-shadow">
              ...
              <div className="p-6 lg:p-8">
                <div className="flex items-start justify-between gap-6">
                  ...
                  <Link
                    to={`/modulo/${slug}/${si}`}
                    className="flex-shrink-0 inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-gradient-to-r from-cyan-500 to-violet-500 text-white text-sm font-semibold hover:shadow-lg hover:shadow-cyan-500/25 transition-all"
                  >
                    Ver temario

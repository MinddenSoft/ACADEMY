    ...
    <section id="temario" className="relative py-24 lg:py-32 bg-white dark:bg-dark-900">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <span className="inline-block px-4 py-1.5 rounded-full bg-pink-500/10 text-pink-600 dark:text-pink-400 text-sm font-semibold mb-4 border border-pink-500/20">Plan de Estudios Completo</span>
          ...
          <p className="text-lg text-slate-600 dark:text-slate-400 max-w-2xl mx-auto">
            6 módulos progresivos diseñados para llevarte desde los fundamentos de programación hasta la implementación experta de sistemas de IA en producción.
          </p>
        </div>
            ...
            <button
              ...
              className={`px-4 py-2 rounded-xl text-sm font-medium transition-all duration-300 ${
                activeFilter === filter.id
                  ? 'bg-gradient-to-r from-emerald-500 to-pink-500 text-white shadow-lg shadow-emerald-500/20'

          ...
          <div className="p-8 sm:p-10 lg:p-14">
            ...
            <div className="p-6 rounded-xl bg-primary-50/50 dark:bg-primary-900/20 border border-primary-200 dark:border-primary-800">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h4 className="font-display font-bold text-lg text-primary-900 dark:text-white">Certificación AI Engineering Professional</h4>
                  <p className="text-neutral-600 dark:text-neutral-400 text-sm">Al completar exitosamente el proyecto final, recibirás tu certificación como AI Engineering Professional.</p>
                </div>
              </div>
            </div>
